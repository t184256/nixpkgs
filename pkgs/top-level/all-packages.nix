...

{
 ...
 enchive = callPackage ../tools/security/enchive { };
  ...
  linux_4_13_scaleway = callPackage ../os-specific/linux/kernel/linux-4.13-scaleway.nix {
    kernelPatches =
      [ kernelPatches.bridge_stp_helper
        kernelPatches.p9_fixes
        # See pkgs/os-specific/linux/kernel/cpu-cgroup-v2-patches/README.md
  ...
  linuxPackages_4_13_scaleway = recurseIntoAttrs (linuxPackagesFor pkgs.linux_4_13_scaleway);
